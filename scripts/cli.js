...
const contractABI = require("../artifacts/contracts/Modelpulsepro.sol/Modelpulsepro.json").abi;

program
    .name("modelpulsepro-cli")
    .description("CLI tool for Modelpulsepro smart contract")
    .version("1.0.0");
