 ...
 * This file demonstrates how to integrate Modelpulsepro with a web frontend
 */

// For React/Vue/Angular applications
export class ModelpulseproClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ModelpulseproClient(provider, contractAddress);
